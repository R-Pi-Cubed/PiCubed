# PiCubed-Minecraft-Installation Assistant
...
Obviously you are going to need a Raspberry Pi. That said your experience will be effected by the model you use. Give yourself the best chance and use the best Pi available. At the time of writing this that is the [Raspberry Pi 4b with 8gb of ram](https://www.raspberrypi.com/products/raspberry-pi-4-model-b/). Minecraft is a ram hog and the latest versions need more ram to function properly. Older model Pis or less ram will work with varying degrees of success. Slower processor speeds of older Pis and the ability to overclock your Pi will also have an effect on your servers performance.
